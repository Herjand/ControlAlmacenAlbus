            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="/ControlAlmacenAlbus/admin/navbar_usuarios/cambiar_password.php" class="btn btn-outline-warning">
                            <i class="bi bi-shield-lock"></i> Cambiar Contraseña
                        </a>
                        <a href="/ControlAlmacenAlbus/admin/navbar_usuarios/cambiar_usuario.php" class="btn btn-outline-info">
                            <i class="bi bi-arrow-left-right"></i> Cambiar de Usuario
                        </a>
                        <a href="/ControlAlmacenAlbus/admin/navbar_usuarios/procesar_logout.php" class="btn btn-outline-danger">
