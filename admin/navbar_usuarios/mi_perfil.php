            ...
            <div class="card shadow-sm mt-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="/ControlAlmacenAlbus/admin/navbar_usuarios/editar_perfil.php" class="btn btn-outline-primary">
                            <i class="bi bi-pencil-square"></i> Editar Perfil
                        </a>
                        <a href="/ControlAlmacenAlbus/admin/navbar_usuarios/cambiar_password.php" class="btn btn-outline-success">
                            <i class="bi bi-shield-lock"></i> Cambiar Contraseña
                        </a>
                        <a href="/ControlAlmacenAlbus/admin/navbar_usuarios/cambiar_usuario.php" class="btn btn-outline-info">
                            <i class="bi bi-arrow-left-right"></i> Cambiar Usuario
                        </a>
                    </div>
                </div>
            </div>
